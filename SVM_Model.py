...
Following code is a modified version of the code from following
source:

van Gent, P. (2016). Emotion Recognition Using Facial Landmarks,
Python, DLib and OpenCV. A tech blog about fun things with Python
and embedded electronics.

Some new features have been added to this program
...
def get_files(emotion): #Define function to get file list, randomly shuffle it and split 80/20
    files = glob.glob("dset1\%s\*" %emotion) #change dataset directory address here!
...
def make_sets():
    ...
    for emotion in emotions: #train for each emotion 
        ...
        for item in training:
            ...
            clahe_image = clahe.apply(gray)#apply local histogram equalization 
            get_landmarks(clahe_image) #extract landmarks 
...
accur_lin = []
for i in range(0,7): #set nunmber of traning iterations here 
